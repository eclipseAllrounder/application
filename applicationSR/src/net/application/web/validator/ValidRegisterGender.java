...
@Named
@RequestScoped
@FacesValidator("net.application.web.validator.emptyGender")
public class ValidRegisterGender implements javax.faces.validator.Validator {
	...
	@SuppressWarnings("unchecked")
	 public void validate(FacesContext context, UIComponent component, Object value)
		...
		String bundleString = bundle.getString("emptyGender");
		
		UIInput usernameField = (UIInput) findComponentInRoot("genderId2", context);
		String username = (String) usernameField.getSubmittedValue();
		
		// Lookup the user by their username
		if(username.contains("genderChoose")){
