...
public class CustomerBean implements Serializable {
    ...
    private static final class CustomerDataModel extends JPADataModel<Customer> {
        private CustomerDataModel(EntityManager entityManager) {
    ...
    public Object getDataModel() {
        return new CustomerDataModel(entityManager);
    }
}
