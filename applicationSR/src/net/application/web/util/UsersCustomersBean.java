...
import org.picketlink.idm.query.Condition;
	...
	@Named
	@SessionScoped
	public class UsersCustomersBean implements Serializable {
		...
		private UsersCustomersModel usersCustomersModel;
		...
		@Inject	private UserCustomerDao userCustomerDao;
		@Inject Logger log;
	    ...
	    private String currentUserCustomerName;
	    
	    
	   
	 
	    public UsersCustomersBean() {
	        initUsersCustomersModel();
	    }
	 
	    public UsersCustomersModel getUsersCustomers() {
	    	log.info("getUsersCustomers");
	    	...
	    	usersCustomersModel = new UsersCustomersModel(mapCondition, sort, entityManager, utx, userDao, customerDao, userCustomerDao);
	        return usersCustomersModel;
	    }
	 
	    private void initUsersCustomersModel() {
	    	System.out.println("initUsersCustomersModel");
	    	setSortFalse();
		 ...
		 public Boolean getSortEnableUp() {
			...
			public void setSortLoginNameDown(Boolean sortLoginNameDown) {
			  ...
			  public String getCustomerListColumnUsernameFilter() {
			    ...
			    public String getCurrentUserCustomerName() {
					return currentUserCustomerName;
				}

				public void setCurrentUserCustomerName(String currentUserCustomerName) {
					this.currentUserCustomerName = currentUserCustomerName;
				}
	}