...
<%@ page import="org.picketlink.social.openid.api.OpenIDManager,org.picketlink.social.openid.web.HTTPProtocolAdaptor,org.picketlink.social.openid.web.HTTPOpenIDContext" %>
<html>
<body>
